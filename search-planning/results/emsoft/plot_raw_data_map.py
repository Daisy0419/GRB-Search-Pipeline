...
def plot_time_vs_nsrc(df_det, output_dir="."):
    ...
    sc = ax.scatter(df_det["n_src"], df_det["mapping_time"],
...
def plot_time_vs_nbkg(df_det, output_dir="."):
    ...
    fig, ax = plt.subplots(figsize=(8, 6))
    sc = ax.scatter(df_det["n_bkg"], df_det["mapping_time"],
...
def plot_time_vs_ratio(df_det, output_dir="."):
    ...
    fig, ax = plt.subplots(figsize=(8, 6))
    sc = ax.scatter(ratio, df_det["mapping_time"],
...
def plot_time_3d(df_det, output_dir="."):
    ...
    sc = ax.scatter(df_det["n_src"], df_det["n_bkg"], df_det["mapping_time"],
                    c=df_det["mapping_time"], cmap="RdYlGn_r",
