...
if __name__ == "__main__":
    EXECUTABLE = "../build/ts"
    map_path_ = "/shared/valid_tests/2.5x2.5/emsoft_maps"
    map_stats_ = "/shared/valid_tests/2.5x2.5/emsoft_stats"
    tile_path = "../data/tilings"
    source_tile_dir = "../data/source_tile_short_rebuttal"  
...
#short utility
    ...
    for deadline in deadlines:
        ...
        for tiling_file in tilefiles:
            ...
            new_result_name = f"short_{tiling}_utility_{deadline}.csv"
    ...
    #short
    map_path_ = "/shared/valid_tests/no-fov-short/emsoft_maps"
    map_stats_ = "/shared/valid_tests/no-fov-short/emsoft_stats"
    tile_path = "../data/tilings"
    source_tile_dir = "../data/source_tile_short_rebuttal"  
    # map_types = ['nodeadline', 'gt']
    map_types = ['nodeadline']
    deadlines = [10, 15, 20, 25, 30, 35, 40, 45, 50]
    ...
    tile_path = "../data/tilings"
    source_tile_dir = "../data/source_tile_longlow_rebuttal"  
    ...
    #longlow
    map_path_ = "/shared/valid_tests/no-fov-longlow/emsoft_maps"
    map_stats_ = "/shared/valid_tests/no-fov-longlow/emsoft_stats"
    tile_path = "../data/tilings"
    source_tile_dir = "../data/source_tile_longlow_rebuttal"  
    # map_types = ['nodeadline', 'gt']
    map_types = ['nodeadline']
