...
std::vector<int> construct_path(const std::vector<std::vector<double>>& costs,
...
std::vector<int> evolution_st(const std::vector<std::vector<double>>& costs, const std::vector<double>& prizes, 
    ...
    for (int i = 0; i < evolution_itr; ++i) {
        ...
        std::vector<std::vector<int>> mutate_paths = std::move(mutate(paths, costs, prizes, budget, num_path));
        std::vector<std::vector<int>> cross_over_paths = std::move(cross_over(paths, costs, prizes, budget, 0));
...
std::vector<int> genetic_optimization_st(const std::vector<std::vector<double>>& costs, const std::vector<double>& prizes, 
    ...
    // std::cout << "start_city: " << start_city << " end_city: " << end_city << "\n";
